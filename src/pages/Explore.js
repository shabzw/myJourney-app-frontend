...
export default function Explore() {
  ...
  return (
    <div>
      <h1
        className="mb-3 text-center rounded py-1"
        style={{ fontFamily: "Satisfy", backgroundColor: "rgb(211,211,211)" }}
      >
      ...
      <div className="container-fluid" style={{ marginBottom: "30px" }}>
        {eData?.map((data) => (
          <div
            key={data?.id}
            className="mb-4 px-2 rounded border-bottom"
                ...
                <div key={event?._id} className="col">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <span
                          className="text-white card-title z-10 px-2 py-1 rounded"
                        ...
                        <Link
                          to={
                            "/explore/" + event?.timelineId + "/" + event?._id
                          }
